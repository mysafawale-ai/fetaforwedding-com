...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/custom-wedding-turban-for-overseas-weddings-in-feta",
    type: "website",
  },
}
...
export default function CustomWeddingTurbanForOverseasWeddingsInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations"],
