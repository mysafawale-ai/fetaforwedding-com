...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/royal-wedding-safa-in-feta",
    type: "website",
  },
}
...
export default function RoyalWeddingSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination", "Expert safa specialists with 40+ years experience in India"],
