...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/ready-made-turban-in-feta",
    type: "website",
  },
}
...
export default function ReadyMadeTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Expert turban specialists with 40+ years experience in India"],
