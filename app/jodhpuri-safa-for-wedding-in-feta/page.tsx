...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/jodhpuri-safa-for-wedding-in-feta",
    type: "website",
  },
}
...
export default function JodhpuriSafaForWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "Expert safa specialists with 40+ years experience in India"],
