...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/safa-for-barati-in-feta",
    type: "website",
  },
}
...
export default function SafaForBaratiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp"],
