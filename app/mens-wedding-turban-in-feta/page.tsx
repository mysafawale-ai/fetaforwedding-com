...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/mens-wedding-turban-in-feta",
    type: "website",
  },
}
...
export default function MensWeddingTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "On-site professional service at your India venue", "Authentic traditional tying techniques perfected over generations", "Expert turban specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India"],
