...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/dulha-pagdi-in-feta",
    type: "website",
  },
}
...
export default function DulhaPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp"],
