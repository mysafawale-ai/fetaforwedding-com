...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/safa-in-feta",
    type: "website",
  },
}
...
export default function SafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Expert safa specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in India"],
