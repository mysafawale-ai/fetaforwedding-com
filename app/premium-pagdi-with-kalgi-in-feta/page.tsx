...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/premium-pagdi-with-kalgi-in-feta",
    type: "website",
  },
}
...
export default function PremiumPagdiWithKalgiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in India"],
