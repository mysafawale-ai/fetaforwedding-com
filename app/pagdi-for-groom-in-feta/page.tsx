...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/pagdi-for-groom-in-feta",
    type: "website",
  },
}
...
export default function PagdiForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Expert pagdi specialists with 40+ years experience in India", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp"],
