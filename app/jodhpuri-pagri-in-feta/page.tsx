...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/jodhpuri-pagri-in-feta",
    type: "website",
  },
}
...
export default function JodhpuriPagriInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Expert pagri specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Complete barati packages with matching coordination"],
