...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/pagri-in-feta",
    type: "website",
  },
}
...
export default function PagriInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagri specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue"],
