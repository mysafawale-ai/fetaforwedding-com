...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/wedding-safa-for-groom-in-feta",
    type: "website",
  },
}
...
export default function WeddingSafaForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit"],
