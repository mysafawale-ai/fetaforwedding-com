...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/hand-tied-turban-for-international-wedding-in-feta",
    type: "website",
  },
}
...
export default function HandTiedTurbanForInternationalWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Expert turban specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day"],
