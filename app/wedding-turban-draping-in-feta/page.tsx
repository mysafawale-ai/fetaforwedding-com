...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/wedding-turban-draping-in-feta",
    type: "website",
  },
}
...
export default function WeddingTurbanDrapingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert turban specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders"],
