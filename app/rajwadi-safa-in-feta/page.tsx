...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/rajwadi-safa-in-feta",
    type: "website",
  },
}
...
export default function RajwadiSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Expert safa specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination"],
