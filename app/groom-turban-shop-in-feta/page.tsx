...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/groom-turban-shop-in-feta",
    type: "website",
  },
}
...
export default function GroomTurbanShopInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your India venue", "Expert turban specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination"],
