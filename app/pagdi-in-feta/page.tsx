...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/pagdi-in-feta",
    type: "website",
  },
}
...
export default function PagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert pagdi specialists with 40+ years experience in India"],
