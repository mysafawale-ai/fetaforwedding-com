...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/custom-wedding-safa-in-feta",
    type: "website",
  },
}
...
export default function CustomWeddingSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp"],
