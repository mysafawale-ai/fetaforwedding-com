...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/sehra-for-groom-in-feta",
    type: "website",
  },
}
...
export default function SehraForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert sehra specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your India venue"],
