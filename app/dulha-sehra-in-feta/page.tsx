...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/dulha-sehra-in-feta",
    type: "website",
  },
}
...
export default function DulhaSehraInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert sehra specialists with 40+ years experience in India", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit"],
