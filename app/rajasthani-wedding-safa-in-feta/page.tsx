...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/rajasthani-wedding-safa-in-feta",
    type: "website",
  },
}
...
export default function RajasthaniWeddingSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "On-site professional service at your India venue"],
