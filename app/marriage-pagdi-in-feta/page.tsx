...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/marriage-pagdi-in-feta",
    type: "website",
  },
}
...
export default function MarriagePagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "On-site professional service at your India venue", "Expert pagdi specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp"],
