...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/groom-safa-bandhej-in-feta",
    type: "website",
  },
}
...
export default function GroomSafaBandhejInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "Competitive pricing for individual and bulk orders", "On-site professional service at your India venue", "Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in India"],
