...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/jodhpuri-pagdi-in-feta",
    type: "website",
  },
}
...
export default function JodhpuriPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert pagdi specialists with 40+ years experience in India", "Free consultation and design preview via WhatsApp"],
