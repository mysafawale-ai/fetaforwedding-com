...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/hand-tied-safa-rental-near-me-in-feta",
    type: "website",
  },
}
...
export default function HandTiedSafaRentalNearMeInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Emergency last-minute service available in India", "Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations"],
