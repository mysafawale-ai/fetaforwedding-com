...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/safa-for-groom-in-feta",
    type: "website",
  },
}
...
export default function SafaForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders"],
