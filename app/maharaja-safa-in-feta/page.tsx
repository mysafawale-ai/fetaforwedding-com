...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/maharaja-safa-in-feta",
    type: "website",
  },
}
...
export default function MaharajaSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Free consultation and design preview via WhatsApp"],
