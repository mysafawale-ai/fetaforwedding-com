...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/safa-on-rent-in-feta",
    type: "website",
  },
}
...
export default function SafaOnRentInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "On-site professional service at your India venue", "Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit"],
