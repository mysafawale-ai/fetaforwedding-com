...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/pagadi-in-feta",
    type: "website",
  },
}
...
export default function PagadiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India"],
