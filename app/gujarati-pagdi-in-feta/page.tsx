...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/gujarati-pagdi-in-feta",
    type: "website",
  },
}
...
export default function GujaratiPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in India", "Emergency last-minute service available in India", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics"],
