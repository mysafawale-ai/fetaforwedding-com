...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/wedding-pagdi-shop-in-feta",
    type: "website",
  },
}
...
export default function WeddingPagdiShopInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Expert pagdi specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics"],
