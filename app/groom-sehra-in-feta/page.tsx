...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/groom-sehra-in-feta",
    type: "website",
  },
}
...
export default function GroomSehraInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Expert sehra specialists with 40+ years experience in India", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in India"],
