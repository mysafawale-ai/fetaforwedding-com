...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/sehra-rental-in-feta",
    type: "website",
  },
}
...
export default function SehraRentalInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Expert sehra specialists with 40+ years experience in India"],
