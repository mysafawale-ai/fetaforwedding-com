...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/groom-pagdi-in-feta",
    type: "website",
  },
}
...
export default function GroomPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations"],
