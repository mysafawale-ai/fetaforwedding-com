...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/groom-pagri-in-feta",
    type: "website",
  },
}
...
export default function GroomPagriInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Expert pagri specialists with 40+ years experience in India", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics"],
