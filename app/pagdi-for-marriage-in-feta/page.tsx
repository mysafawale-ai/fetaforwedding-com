...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/pagdi-for-marriage-in-feta",
    type: "website",
  },
}
...
export default function PagdiForMarriageInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders"],
