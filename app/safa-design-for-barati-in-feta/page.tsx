...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/safa-design-for-barati-in-feta",
    type: "website",
  },
}
...
export default function SafaDesignForBaratiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "Customized designs matching your wedding theme and outfit"],
