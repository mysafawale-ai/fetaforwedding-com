...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/safa-for-men-in-feta",
    type: "website",
  },
}
...
export default function SafaForMenInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in India", "On-site professional service at your India venue", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit"],
