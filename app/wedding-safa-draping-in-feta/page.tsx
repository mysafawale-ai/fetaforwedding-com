...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/wedding-safa-draping-in-feta",
    type: "website",
  },
}
...
export default function WeddingSafaDrapingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations"],
