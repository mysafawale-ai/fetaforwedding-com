...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/marathi-pheta-in-feta",
    type: "website",
  },
}
...
export default function MarathiPhetaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination"],
