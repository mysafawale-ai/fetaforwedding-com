...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/groom-feta-in-feta",
    type: "website",
  },
}
...
export default function GroomFetaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "On-site professional service at your India venue"],
