...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/turban-in-feta",
    type: "website",
  },
}
...
export default function TurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Emergency last-minute service available in India"],
