...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://fetaforwedding.com/dulhe-ka-sehra-in-feta",
    type: "website",
  },
}
...
export default function DulheKaSehraInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day"],
